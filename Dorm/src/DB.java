...
{
     Connection con;
     String serv[]={"WiFi","Food","Maintenance","Backup Power"};
    DB()
    {
     try
        {
            ...
            con=DriverManager.getConnection("jdbc:mysql://localhost/appartment?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","root","");
